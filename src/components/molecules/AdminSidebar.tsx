...
const AdminSidebar: React.FC<SidebarProps> = React.memo(({
  sidebarOpen,
  setSidebarOpen,
}) => {
          ...
          <div>
            ...
            <ul className="flex flex-col gap-1.5">
              <li>
                <NavLink
                  to="/admin/profile"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-black duration-300 ease-in-out hover:bg-gray dark:text-white dark:hover:bg-meta-4 ${
